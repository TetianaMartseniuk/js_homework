...
function porch(n) {
    ...
    /*git branch сoздать ветку*/
    /*git fetch подтянуть себе все ветки*/

    /*git flow    1(pc-8264) 2 3
    (branch) master
              staging
              development(merge все что есть здесь себе pc-8264, если есть мерж таска сдана)
              pc-8264
              pc-8277*/
 /*commit на кажд задание
 git push origin hw1
